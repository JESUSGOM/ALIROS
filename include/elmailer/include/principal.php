    ...
    <div class="row">
        <p>
            <?php
                ...
                //echo var_dump($_GET);
                print"<p><b>$centroDen $espacio Usuario-></b>$estaidentificacion $espacio $identi $espacio $apellidoUno $espacio $apellidoDos $coma $nombre</p>";
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card card-body">
                ...
                <form action="informesllaves.php" method="POST">
                    <input type="submit" class="btn btn-success btn-block"
        ...
        <div class="col-md-4">
            <div class="card card-body">
                ...
                <form action="informesllamadas.php" method="POST">
                    <input type="submit" class="btn btn-success btn-block"
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-body">
                ...
                <form action="informesincidencias.php" method="POST">
                    <input type="submit" class="btn btn-success btn-block"
                    name="entroincidencia" value="Informes Incidencias">
                </form>
            </div>
        </div>
        <div class="col-md-4">
