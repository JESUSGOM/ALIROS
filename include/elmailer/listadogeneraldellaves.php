...
<div class="container-fluid p-4">
    <div class="row" width="100%">
        <?php
            ...
            print"<p><b>$espacio $espacio $cenden $espacio Usuario-></b> $estaidentificacion $espacio $apell1 $espacio $apell2 $coma $nom $espacio</p>";
    ...
    <div class="row" width="100%" height="60%;">
        <div class="card card-body">
            <table id="dtDynamicVerticalScrollExample" class="table table-striped table-bordered" cellspacing="0" style ="width: 100%; height:10%;">
                <thead>
                    <tr>
                        <th class="th-sm" scope="col"><b>Código.</b>
                        <th class="th-sm" scope="col"><b>Puerta.</b>
                        <th class="th-sm" scope="col"><b>Planta.</b>
                        <th class="th-sm" scope="col"><b>Cajetín.</b>
                        <th class="th-sm" scope="col"><b>Restricción.</b>
                    </tr>
                </thead>
                <tbody>
                    <?php
                        $esquery = "SELECT LlvCodigo, LlvPuerta, LlvPlanta, LlvCajetin, LlvRestriccion FROM Llaves WHERE LlvCentro = '".$numero."'";
