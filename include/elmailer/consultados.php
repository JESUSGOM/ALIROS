<?php
    ...
    session_start();
    //$usuariologueado = $_SESION['usuario'];
    //$clavelogueada = $_SESSION['clave'];
            ...
            while($fila = mysqli_fetch_row($resultado)){
                ...
                if($resulta2 = mysqli_query($conn, $query2)){
                    while($fila2 = mysqli_fetch_row($resulta2)){
                        ...
                        $_SESSION['deniminacionCentro'] = $nombreCentro;
                    }
                }
                session_start();
