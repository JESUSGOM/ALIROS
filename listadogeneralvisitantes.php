...
<div class="container-fluid p-4">
    <div class="row">
        <?php
            ...
            print"<p><b>$cenden $espacio Usuario-></b> $estaidentificacion $espacio $apell1 $espacio $apell2 $coma $nom $espacio $super</p>";
        ?>
    </div>
            ...
            <table id="dtDynamicVerticalScrollExample" class="table table-striped table-bordered" cellspacing="0" style ="width: 100%; height:10%;">
                ...
                <tbody>
                    <?php
                        ...
                        FROM Movadoj 
                        WHERE MovCentro = '" .$numero. "' GROUP BY ElCampo ORDER BY ElCampo ASC";
