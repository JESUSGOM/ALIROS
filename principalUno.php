<?php
    ...
    if(isset($_POST['entrada'])){
        ...
        UsuTipo, UsuCargo FROM Usuarios 
    ...
    <div class="row">
        <p>
            <?php
                ...
                print"<p>
                        <b>
                            $espacio $espacio $espacio $centroDen $espacio Usuario->
                        </b>
        ...
        <div class="col">
            <div class="card card-body">
                <form action="visitaPorNombresYears.php" method="POST">
                    ...
                    <input type="hidden" name="rol" value="<?php echo $cargoUsuario;?>"/>
